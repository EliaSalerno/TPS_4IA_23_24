...
void loop() {
     ...
     */
    Serial.println(F("Send NECRaw 0x6F905583")); // epson  ON-OFF
    IrSender.sendNECRaw(0x6F905583, sRepeats);

    //Serial.println(F("Send NECRaw 0x758ACD32")); // bonaiti mute on-off
    //IrSender.sendNECRaw(0x758ACD32, sRepeats);
